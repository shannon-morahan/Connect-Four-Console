...
namespace ConnectFour.GameOverConditions
{
    ...
    /// That is, same colour 4 times in a row.
    /// </summary>
    public class HorizontaGameOverCondition : IGameOverCondition
    {
        /// <summary>
        /// Iterates the board and returns true if 4 pieces of the same colour are found in a row
        /// </summary>
        /// <param name="board">The current playing board</param>
        /// <returns>True if 4 of the same colour are found horizontally, false otherwise</returns>
